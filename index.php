    ...
    <body>
        ...
        <div id="p2" class="second-page">
            <div class="container">
                ...
                <div class="row disp-change">
                    <div class="two columns">
                        <img alt="Krzysztof Nowicki" 
                             src="images/king.png" 
                             class="u-max-full-width"
                             onmouseover="hover('Tutaj znajdzie się opis jeśli kandydat zostanie zaakceptowany.', 'kn')"
                             onmouseout="hover('Krzysztof Nowicki', 'kn')">
                    </div>
                    
                    <div class="four columns second-row-height disp" id="kn">
                        <p>Krzysztof Nowicki</p>
                    </div>
                    
                    <div class="two columns">
                        <img alt="Tomasz Wieroński" 
                             src="images/moris.png" 
                             class="u-max-full-width" 
                             onmouseover="hover('Tutaj znajdzie się opis jeśli kandydat zostanie zaakceptowany.', 'tw')"
                             onmouseout="hover('Tomasz Wieroński', 'tw')">
                    </div>
                    
                    <div class="four columns second-row-height disp" id="tw">
                        <p>Tomasz Wieroński</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="container" id="last-container">
                ...
                dd                 class="u-max-full-width image-foot" >
                    ...
                    <div class="one-third column">
                        ...
                        <div class="row">
                            <a href="https://www.dropbox.com/" target="_blank" class="icon-link db"><i class="demo-icon icon-dropbox">&#xf16b;</i></a>
                        </div>
                        <div class="row">
                            <a href="https://github.com/" target="_blank" class="icon-link gh"><i class="demo-icon icon-github-circled-alt2">&#xf056;</i></a>
                        </div>
                    </div>
                </div>
            </div>
